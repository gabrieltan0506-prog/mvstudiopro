...
| 原生读片设置 | PR1328本地追加：分片秒数与采样fps独立设置，旧记录默认300秒/10fps；当前待测319秒/12fps，原速。Gemini MEDIUM、GLM整集与系列medium；本轮五片各一次Gemini，收齐后一次整集GLM，不额外系列聚合。实测过关后才冻结；倍速未实现，本批仍待推送/付费实跑。 |
