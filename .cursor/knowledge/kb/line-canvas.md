...
- 本地类型、构建、21 个相关测试文件 195 项和 diff-check 已通过；全仓余 5 项失败均可在 `origin/main` 同源定位到陈旧读片断言。本条尚未提交、推送、合并、部署或真实付费跑片。完整施工与无损回退见 /Users/tangenjie/Downloads/2026Sep04/plans-and-undo.md。
