...
- **五片验收状态（2026-08-31）**：先验原速319秒/12fps，过关后再冻结参数；本轮未新增冻结机制。全仓3680项及类型检查通过，旧batch的fps丢失、本机dotenv和编译漏检已补；keyMoments秒位首条对齐既有0.1秒Schema。Gemini逐片独立请求；GLM整集medium/系列max保持各自实际配置。尚未推送本批、未用新镜像进行五片模型及GLM质量验收，不得以离线绿灯代替。
