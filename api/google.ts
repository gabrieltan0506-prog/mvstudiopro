 ...
 * - op=vertexTranslate（Vertex IAM 纯文本翻译；location=**global**；模型 gemini-3-flash-preview，供 TestLab）
...
export default async function handler(req:VercelRequest,res:VercelResponse){
  try{
    ...
    // ---------------- Vertex：TestLab 翻译（gemini-3-flash-preview、global；与 geminiScript 同为 IAM REST，非 @google-cloud/vertexai SDK） ----------------
