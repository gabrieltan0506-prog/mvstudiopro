/**
 * 仅供 manhuaClipPrepareLatest.browser.test.ts：
 * 挂真的 OmniCanvas；FreeformCanvas 被 esbuild alias 换成 probe 壳，
 * 于是测试能拿到**真实页面**的 prepareManhuaClipRun / resolveManhuaOutboundGate，
 * 并观察重新渲染后它们是否更新（React 旧闭包问题）。
 *
 * 会话夹具沿用 omniCanvasDirectionConfirm.fixture.tsx 的那一份（已验证可过剧本就绪）。
 */
