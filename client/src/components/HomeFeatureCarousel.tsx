...
const PINNED_CARD = {
  ...
  desc: "集成小红书、抖音、快手、B站四平台实时热门内容库，双引擎深度扫描竞品流量密码，生成差异化人设定位、执行脚本与30天增长路径，单次20点即可获得降维打击方案。",
...
const CAROUSEL_CARDS = [
  ...
  },
  {
    ...
    desc: "AI 自动调取您的历史分析快照，与当前课题进行「大洗牌」对比，输出专属战略升级方案。含10大可执行里程碑、竞争力雷达评分、四平台协同矩阵与完整数据表格。",
  ...
  },
  {
    ...
    tag: "今日上线",
    title: "战报数据图表全面升级",
    subtitle: "强制输出真实数据表格 · 四平台对比矩阵 · 转化漏斗",
  ...
  },
  {
    ...
    desc: "首页添加免费试读区！战略半月刊「医美赛道」样本与私人订制「知识博主」样本，含真实数据表格与部分精华内容，全版水印保护，一键打印保存为 PDF。",
  ...
  },
  {
    ...
    desc: "「我的战报」全面升级！每份报告展示 Nano Banana Pro 生成的艺术封面（3:4 比例）、AI 灯塔标题、内容摘要与生成耗时，一键全息阅览或下载 Markdown 原文。",
              ...
              <div style={{ display: "flex", alignItems: "flex-start", gap: 16 }}>
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ color: "rgba(245,218,150,0.65)", fontSize: 13, lineHeight: 1.75, margin: "0 0 14px", maxWidth: 680 }}>
                    停止在信息泥潭中盲目试错。三档产品覆盖所有需求：<strong style={{ color: "#a78bfa" }}>战略半月刊</strong>追踪最新赛道趋势，<strong style={{ color: "#34d399" }}>半年订阅</strong>享持续战略陪伴，<strong style={{ color: "#f97316" }}>尊享季度私人订制</strong>与历史数据深度对比实现「二次进化」。全系报告强制含真实数据表格与四平台对比矩阵。
                  </p>
