...
export default function InvitePage() {
  ...
  if (authLoading) {
    return (
      <div className="min-h-dvh bg-transparent flex items-center justify-center p-6">
  ...
  if (!isAuthenticated) {
    return (
      <div className="min-h-dvh bg-transparent flex flex-col items-center justify-center gap-3 p-6 text-center">
