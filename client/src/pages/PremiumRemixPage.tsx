...
export default function PremiumRemixPage() {
  ...
  }, [fileBase64, selectedFile, inputKind, supervisorAccess, checkAccessMutation, fileSize, analyzeDocumentMutation, analyzeVideoMutation, fileMimeType, fileName, context, "gemini-3.1-pro-preview", usageStatsQuery, isPremiumRemixPage]);
            ...
            <div className="rounded-[28px] border border-white/10 bg-black/20 p-5 backdrop-blur-sm">
              ...
              <div className="mt-5">
                <div className="rounded-2xl border border-[#ff8a3d]/20 bg-[rgba(255,138,61,0.08)] px-4 py-3 text-sm text-[#ffd4b7]">
                  二创页固定使用 Gemini 3.1 Pro Preview，先生成成长营判断，再做二创升级。
                </div>
              </div>
          ...
          <section className="mt-8 space-y-6">
            <div className="rounded-[24px] border border-cyan-300/20 bg-cyan-400/10 p-5">
                ...
                <div className="mt-3 grid gap-2 text-sm text-white/75 md:grid-cols-2">
                  ...
                  <div>当前选择模型：{"gemini-3.1-pro-preview"}</div>
