...
const SHOWCASE_CONTENT = [
    ...
    { type: "feature" as const, icon: Paintbrush, title: "AI 图像生成", desc: "全新 AI 图像生成引擎，支持多种风格，为你的视频创作绝美视觉素材", color: "#C77DBA" },
...
export default function VideoSubmit() {
  ...
  return (
    <div className="min-h-dvh bg-transparent text-[#F7F4EF] p-4 sm:p-8 flex items-center justify-center">
