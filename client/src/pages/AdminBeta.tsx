...
export default function AdminBeta() {
  ...
  if (!isAuthenticated || user?.role !== "admin") {
    return (
      <div className="min-h-dvh bg-transparent flex flex-col items-center justify-center p-6 text-center">
  ...
  return (
    <div className="min-h-dvh bg-transparent text-[#F7F4EF] p-4 sm:p-6 lg:p-8">
