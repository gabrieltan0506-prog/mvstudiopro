      ...
      {tab === "translate" && (
        <div style={{ marginTop: 20, padding: 16, borderRadius: 16, border: "1px solid rgba(255,255,255,0.12)", background: "rgba(0,0,0,0.20)" }}>
          ...
          <div style={{ marginTop: 8, opacity: 0.8 }}>
            模型 <code style={{ fontSize: 12 }}>gemini-3.1-flash-live-preview-latest</code>，区域 <code style={{ fontSize: 12 }}>us-central1</code>，与「脚本」同属 Vertex IAM <code>/api/google</code> 闸道。
          </div>
