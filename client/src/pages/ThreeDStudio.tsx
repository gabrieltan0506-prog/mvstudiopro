...
const DIMENSION_PACKS: PricingPack[] = [
  { name: "维度·体验包", subtitle: "新用户专享", contents: "闪电 3D × 3 次", price: "15 Credits", discount: "限购 2 次", color: "#30D158" },
...
const COMPATIBLE_SOFTWARE = [
  { name: "Blender", icon: Orbit, desc: "开源工具" },
...
export default function ThreeDStudioPage() {
  ...
  return (
    <div className="min-h-dvh bg-transparent text-[#F7F4EF] page-enter">
      ...
      <div className="flex-grow">
        ...
        <div className="bg-[#1A1A1D] rounded-2xl p-6 mt-8">
          <CreationHistoryPanel type="idol_3d" title="3D 模型生成历史" />
        </div>
