...
export const CREDIT_COSTS = {
  ...
  /** 选题初选 20 条（标明 Skill / 传达目标）；可单独重生成 */
  platformTopicShortlist: 12,
  /** 勾选 5–6 条初选后正式扩写文案 + 图文页结构 */
...
export const CREDIT_FEATURE_BREAKDOWN: readonly CreditFeatureBreakdownRow[] = [
  ...
  { product: "平台数据分析", subFeature: "选题初选（20条）", credits: CREDIT_COSTS.platformTopicShortlist, note: "每条标明 Skill 与传达目标；可重生成" },
  { product: "平台数据分析", subFeature: "初选扩写（5–6条正式文案）", credits: CREDIT_COSTS.platformTopicExpand, note: "含 graphicNotePages 可发图文结构" },
