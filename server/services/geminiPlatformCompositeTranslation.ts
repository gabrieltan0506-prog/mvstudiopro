...
${sublineRule}
- **提亮杀伤字**：主句内仅 **2–6 个关键字**用鲜明黄或亮蓝/霓虹粉标出；其余白/浅色；不要为「说完整」再堆说明书墙。
- **版式·网感张力**：主信息仍是「${hook}」；允许左右竖排关键词夹人脸、背后巨大竖排「真相」类字、黄底提亮块、主词**轻微变形/厚描边/立体感**增停滑（须可读）；禁止把「点开全文 / 救急大招 / 各地名单」等 CTA 或正文摘要印上封面。
- **禁止**百科封面：长段论述、履历堆砌、四条以上卖点清单、多图标+多辅标栏、说明书式信息图。
- **禁止**默认暗沉、低照度、压抑严肃、葬礼感光影；须**生活化、年轻化、健康化、有温度的高级感**；优先便利店/家装/哄娃客厅等烟火气场域，或偶用抽象冲击动作（同批勿滥用）。
- 优先自然日光 / 户外或生活场域、明快克制配色 + 一处鲜明强调色；高级时尚可以，但要有点击欲，不要死板正装肖像海报。
- **有人物时·表情姿势硬约束（压过「挺拔从容冷淡大片」与「坐姿复读」）**：禁止正面端坐办公桌/咖啡桌、端杯正视、证件照微笑、对称讲课站姿。必须画成**一眼有事发生**——可选**帅气运动定格**（网球发球展体、爬山登顶远眺、游泳出水、挥拍随球）或**有戏表情/动态**（瞪大眼不信、错愕、坏笑、陶醉、跳跃、失衡、探身递物）；**不要求搞笑**，同批须姿势轮换、勿全坐着、也勿全挤同一表情。
...
- 可借鉴小红书网感封面的「大字停滑、关键字亮色、侧栏/竖排张力」，但人物须有戏（含运动帅气线与清单证据线），勿正坐上课脸。
