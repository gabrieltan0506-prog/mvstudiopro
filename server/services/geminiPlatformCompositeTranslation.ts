...
- **场景服饰硬锁（防穿帮）**：动作决定服装——网球发球必须网球运动装（短袖/网球裙裤+球鞋+球拍），**禁止长大衣/西服外套打网球**；游泳用泳装；爬山用户外功能装；厅堂访谈才可用西装/丝绸衬衫。锁脸时仍须丰富姿势，且衣着跟场景。
- 可借鉴小红书知识封面的「大字少、关键字亮色、干净构图」，但人物须有戏（含运动帅气线），勿正坐上课脸。
