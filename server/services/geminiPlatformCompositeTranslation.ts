...
- 图标与重点标示（**上篇、下篇都要达到此密度，以「下篇」的丰富程度为统一模板**）：每一条要点都配一个立体透视、多彩强对比的素描图标；并对关键术语 / 数字 / 步骤做醒目**重点标示**（高亮色块、描边徽章、序号圆标、彩色标签等）。整页图标与重点标示要**丰富而密集**，加深各类知识的印象、强化视觉冲击与可读层次。
