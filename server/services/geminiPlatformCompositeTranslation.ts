...
- **有人物时·表情姿势硬约束（压过「挺拔从容冷淡大片」与「坐姿复读」）**：禁止正面端坐办公桌/咖啡桌、端杯正视、证件照微笑、对称讲课站姿。必须画成**一眼有事发生**——可选**帅气运动定格**（网球发球展体、爬山登顶远眺、游泳出水、挥拍随球）或**有戏表情/动态**（瞪大眼不信、错愕、坏笑、陶醉、跳跃、失衡、探身递物）；**不要求搞笑**，同批须姿势轮换、勿全坐着、也勿全挤同一表情。时装/运动装跟场域；锁脸时仍须丰富姿势。
