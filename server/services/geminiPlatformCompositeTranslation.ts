...
- **版式·A1 网感全壳**：主信息仍是「${hook}」；可选用侧栏夹字 / 真相竖排 / 黄底粗标 / 绿杀伤 / 黑金大数字 / 简约情绪条 / 变形字张力；忌塑料说明书墙与 CTA 墙。
...
- **有人物时·文案档位=表情动作档位（硬）**：禁止望窗外发呆、证件照微笑、正襟危坐与夸张标题同框。必须**一眼有事发生**，且与主句同拍：吃喝/减脂向优先**张口大吃、鼓腮咀嚼、叉子怼嘴**；若主句含「三件事/N步」可**竖起三指/比数字**呼应好奇环；亦可错愕/坏笑/陶醉/探身递物/运动定格。同批姿势轮换，勿全坐着、勿全挤同一表情。
