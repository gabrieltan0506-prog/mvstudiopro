...
【停滑封面·硬约束】
- 主标题用**简体中文**，**严格 8–14 字**，大而清晰、印刷级，**必须且只能**呈现「${hook}」；禁止把更长选题标题、论文式副标、整段解释印上封面。
${sublineRule}
- **少字提亮**：主句内仅 **2–6 个关键字**用鲜明黄或亮蓝标出；其余白/浅色；不要为「说完整」再加第三行说明文字。
- **字数上限（最高优先级）**：屏上可见汉字合计约 **≤28 字**；禁止把「点开全文 / 救急大招 / 各地名单」等 CTA 或正文摘要印上封面；正文留给笔记页，封面只负责停滑主句。
