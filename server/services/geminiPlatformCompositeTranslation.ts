...
${sublineRule}
- **提亮杀伤字**：主句内仅 **2–6 个关键字**用鲜明黄或亮蓝标出；其余白/浅色；不要为「说完整」再加第三行说明文字。
- **版式**：屏上可见文案最多 2 行；禁止把「点开全文 / 救急大招 / 各地名单」等 CTA 或正文摘要印上封面；正文留给笔记页，封面只负责停滑主句。
...
- 可借鉴小红书知识封面的「大字少、关键字亮色、干净构图」，但人物须有戏（含运动帅气线与清单证据线），勿正坐上课脸。
