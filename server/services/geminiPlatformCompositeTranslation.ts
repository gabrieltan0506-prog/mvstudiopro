...
- **有人物时·表情姿势硬约束（压过「挺拔从容冷淡大片」与「坐姿复读」）**：禁止正面端坐办公桌/咖啡桌、端杯正视、证件照微笑、对称讲课站姿。必须画成**一眼有事发生**——瞪大眼不信、错愕、坏笑、陶醉、跳跃、差点摔倒失衡、探身递物怼镜头、回头、侧身大步等至少一项；同题多封面勿全坐着。时装质感可保留，脸与身体先服务停滑。锁脸参考时仍须丰富表情姿势。
- 可借鉴小红书知识封面的「大字少、关键字亮色、干净构图」，但人物须有戏，勿正坐上课脸。
