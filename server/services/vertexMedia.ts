...
export const VERTEX_IMAGE_LOCATION_FLASH = "asia-east1";
export const VERTEX_IMAGE_LOCATION_PRO = "asia-east1";
export const VERTEX_IMAGE_LOCATION_UPSCALE = "us-central1";
