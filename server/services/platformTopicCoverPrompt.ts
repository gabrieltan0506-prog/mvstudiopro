...
export const PLATFORM_SHARED_IMAGE_PHOTOGRAPHY_MODIFIERS = [
   ...
   */
  "CTR COVER BRIEF: print ONE punchy Simplified Chinese hero line (MAX 13 chars incl. punctuation; shorten if longer) that creates curiosity or contrast (number twist / anti-common-sense / unexpected outcome), plus optional tiny subline; breathable spacing, highlight 2–6 key characters; NO paragraphs, NO tip lists, NO footer CTA walls, NO answer spoilers",
