...
const INDUSTRY_TEMPLATES: IndustryTemplateDefinition[] = [
  ...
  },
  {
    ...
    commercialFocus: "先用高频冲突场景创建信任，再承接深度咨询和课程。",
  ...
  },
  {
    ...
    commercialFocus: "先创建专业可信度，再承接诊断、陪跑或长期管理。",
  ...
  {
    id: "sports-equipment-ecommerce",
    name: "健身器材与体育用品电商",
    audience: "想买健身器材、运动护具、体育用品，并关心适不适合自己、值不值得买的人群。",
    painPoint: "用户不缺器材画面，缺的是适用人群、训练场景、核心差异和为什么现在值得买。",
    positioningHint: "定位成帮用户快速完成器材购买判断的人，而不是只拍运动氛围和产品外观的人。",
    analysisHint: "先讲适合谁、解决什么训练问题、和普通器材差在哪，再讲参数和外观。",
    trustAsset: "真实训练演示、不同人群适用说明、前后对比、参数对照、买家反馈。",
    primaryConversion: "商品页、橱窗、套餐组合、私域复购。",
    commercialFocus: "优先跑通单品成交，再扩到套餐、训练方案和复购，不先做知识付费或社群。",
    offerExamples: ["单品成交", "套装组合", "训练场景对照", "老客复购"],
    keywords: ["健身器材", "体育用品", "运动器材", "器械", "哑铃", "跑步机", "壶铃", "拉力器", "护具", "瑜伽垫", "球拍", "球类", "体能训练", "训练器械", "健身装备"],
  },
  {
    id: "ecommerce-seller",
    name: "电商卖家",
  ...
  },
  {
    ...
    commercialFocus: "先用高频育儿场景创建信任，再承接长期陪伴或母婴产品转化。",
  ...
  },
  {
    ...
    commercialFocus: "先用高频痛点创建信任，再承接更高信任度的咨询和长期服务。",
  ...
  },
  {
    ...
    commercialFocus: "先用真实空间改造创建信任，再承接产品和服务转化。",
  ...
  },
  {
    ...
    commercialFocus: "先创建信任和判断力，再承接品牌合作和高客单线索。",
  ...
  },
  {
    ...
    commercialFocus: "先用真实产地和价值创建信任，再承接商品与合作。",
  ...
  },
  {
    ...
    commercialFocus: "先创建专业信任，再承接用品、服务与品牌合作。",
  ...
  },
  {
    ...
    commercialFocus: "先用高频风险场景创建信任，再承接专业服务。",
