...
export const sampleGrowthSignals = buildMockGrowthSnapshot({
  analysis: {
    ...
    languageExpression: "样例语言表达分析",
    emotionalExpression: "样例情感表达分析",
    cameraEmotionTension: "样例镜头张力分析",
    bgmAnalysis: "样例 BGM 分析",
    musicRecommendation: "样例配乐建议",
    sunoPrompt: "Sample premium ambient soundtrack prompt for Suno.",
    trustSignals: [],
    visualRisks: [],
    keyFrames: [],
    strengths: ["画面风格清晰"],
