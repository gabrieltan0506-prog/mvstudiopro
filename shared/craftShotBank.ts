...
const TOPIC_CRAFT_HINTS: Array<{ keys: string[]; preferIds: string[] }> = [
  ...
  { keys: ["谍战", "卧底", "情报", "对峙审讯"], preferIds: ["light_07_top_cut", "cam_02_locked_long", "emo_01_restrained_dread"] },
  { keys: ["群戏", "派对", "众人", "围观"], preferIds: ["emo_06_ensemble_pulse", "cam_03_track_follow", "tr_04_whip_bridge"] },
  {
    keys: ["奇观", "秘境", "史诗", "巨物", "星际", "修仙", "洞府", "吞噬", "进化", "灵根", "万妖"],
    preferIds: ["cam_07_wide_scale", "light_04_volumetric", "emo_08_solemn_quiet"],
  },
  ...
  {
    keys: ["甜", "恋爱", "暧昧", "治愈", "心动", "告白", "团宠", "小师妹"],
    preferIds: ["light_05_neon_spill", "cam_06_intimate_cu", "emo_03_ambiguous_longing"],
  },
  { keys: ["悬疑", "秘密", "揭秘", "调查", "推理", "搜证", "狼人", "吸血鬼"], preferIds: ["light_07_top_cut", "cam_04_whip_insert", "emo_07_obsessive_calm"] },
  {
    keys: ["追逐", "赛车", "速度", "动作", "逃", "飙车", "电竞", "竞技", "操作"],
    preferIds: ["cam_03_track_follow", "tr_04_whip_bridge", "emo_06_ensemble_pulse"],
  },
  { keys: ["家庭", "伦理", "饭桌", "长辈", "团圆", "婆媳"], preferIds: ["cam_08_shot_reverse", "emo_05_family_tension", "light_01_window_motivated"] },
  {
    keys: ["和解", "亲情", "温暖", "发现", "重逢", "释然", "种田", "渔乡", "田园"],
    preferIds: ["light_06_magic_hour", "cam_05_low_wonder", "emo_02_warm_wonder"],
  },
  {
    keys: ["谈判", "商战", "霸总", "会议室", "并购", "赘婿", "财神", "逆袭"],
    preferIds: ["emo_04_cold_control", "cam_08_shot_reverse", "light_07_top_cut"],
  },
  ...
  {
    keys: ["末日", "末世", "废土", "避难所", "丧尸", "废柴"],
    preferIds: ["cam_07_wide_scale", "light_03_high_contrast", "emo_01_restrained_dread"],
  },
  {
    keys: ["科幻", "飞船", "赛博", "全息", "游戏", "系统觉醒"],
    preferIds: ["cam_07_wide_scale", "light_04_volumetric", "emo_08_solemn_quiet"],
  },
