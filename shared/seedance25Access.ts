 ...
 *
 * 用户 2026-08-05 明文口径：
 * - 对外宣称 **Seedance 2.5 于 8 月 8 日上线**，首页读秒倒计时；到点**自动**对用户开放，不必再发版。
...
/** 上线时刻：2026-08-08 00:00 (UTC+8) */
export const SEEDANCE_25_LAUNCH_AT_ISO = "2026-08-08T00:00:00+08:00";
export const SEEDANCE_25_LAUNCH_AT_MS = Date.parse(SEEDANCE_25_LAUNCH_AT_ISO);

/** 对外文案（用户明文授权可写引擎名与日期） */
export const SEEDANCE_25_LAUNCH_DATE_LABEL_ZH = "8 月 8 日";
export const SEEDANCE_25_LAUNCH_DATE_LABEL_EN = "August 8";
export const SEEDANCE_25_COUNTDOWN_TITLE_ZH = "Seedance 2.5 上线倒计时";
export const SEEDANCE_25_COUNTDOWN_SUBTITLE_ZH =
  "成片·加长 · 单段最长 30 秒 · 8 月 8 日开放，正式会员可用";
...
export const SEEDANCE_25_BEFORE_LAUNCH_LABEL_ZH =
  "成片·加长将于 8 月 8 日开放，敬请期待；在此之前请使用成片·快速";
