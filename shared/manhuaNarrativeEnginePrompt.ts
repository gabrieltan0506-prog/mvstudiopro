...
/** 短剧默认节奏（预算期 ≈ 5–6 段；成熟后再扩 10–12） */
export const MANHUA_SHORT_DRAMA_ARC_BLOCK = `【短剧默认弧·预算期】
整集约 75–90 秒（约 5–6 段 × 15 秒）：
0–15 秒：压力/冲突/反差钩子；
中段（约 2–3 段）：目标受阻、人物互动升级、道具/身份信息兑现、可含对白→肢体冲突的引爆；
...
1. 形象连续（最高优先）：发型、五官、服装主色与已锁定静帧同一人同装，禁止换脸换装。
