...
const TOPIC_MOTION_HINTS: Array<{ keys: string[]; preferIds: string[] }> = [
  { keys: ["电竞", "故障", "RGB", "赛博", "游戏", "竞技", "操作"], preferIds: ["logo_03_rgb_flash", "logo_01_stroke_glow"] },
  ...
  { keys: ["数据", "增长", "报表", "图表", "看板", "KPI", "指标", "战报"], preferIds: ["data_01_dashboard", "data_06_bar_race"] },
  { keys: ["赛跑", "排名", "柱状", "吊打"], preferIds: ["data_06_bar_race", "data_01_dashboard"] },
