/**
 * 漫剧工厂：英文运镜/镜头说明 → 通顺中文（GPT-5.6 Terra）
 * 人设：电影编剧与剧本创作大师；只用于用户可见说明与中文剧本侧，不替代 Seedance EN 锁。
 */
...
export const MANHUA_SCREENWRITER_TRANSLATE_BRIEF = [
  ...
  "任务：把下列英文运镜/镜头/动作说明，翻译成通顺、专业、可给中文剧组直接朗读与执行的中文。",
  "硬性要求：",
  "1. 只输出中文正文，不要标题、不要 JSON、不要解释翻译过程、不要英文原文对照。",
