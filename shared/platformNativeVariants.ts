...
export function composePlatformImageSkillHints(
  ...
  if (forceCover || on("cover-stop-scroll")) {
    parts.push(
      "【封面出图·高点击短钩】coverHeadline 约 10–18 字，须带数字反差/反常识/猎奇缺口；主信息轴清晰；允许侧栏/竖排与轻微变形厚描边；提亮用香槟金/暖琥珀（忌荧光粉绿俗气）；禁止论文式长 hook/CTA 墙；有人物禁坐姿上课脸——**文案多拧则表情动作同档**（吃喝向张口大吃/鼓腮/叉子怼嘴；亦可错愕/坏笑/发球/登顶）；禁望窗外发呆配大字；同批勿全坐着；**场景服饰防穿帮**：发球穿网球运动装；屏内字简体中文；有参考人像须锁脸。",
