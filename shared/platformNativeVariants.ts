...
export function composePlatformImageSkillHints(
  ...
  if (forceCover || on("cover-stop-scroll")) {
    parts.push(
      `【封面出图·高点击短钩】coverHeadline 最多 ${PLATFORM_COVER_HEADLINE_MAX_CHARS} 字（超则精简）；须带反差/猎奇/好奇缺口；A1 壳与配色池轮换（暖黄/品红/真相红/吸睛绿/黑金/桃/玫瑰金/蓝/香槟金等，勿锁死单色）；允许侧栏夹字/竖排/粉系双行；禁变形花字墙、答案剧透与荧光撞色；字勿挤成一团；有人物时表情按选题定档（平和选题用自然神态，反差选题才上错愕/张口大吃/竖指）；主句很拧时禁望窗外发呆，主句平和时也别满脸用力；屏内字简体中文；有参考人像须锁脸。`,
