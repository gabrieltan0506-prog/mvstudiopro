...
export function classifyManhuaDirectionSceneType(text: string): ManhuaDirectionSceneType {
  ...
  const action = count(
    /拔刀|拔剑|挥拳|挥刀|挥剑|砍来|砍去|砍向|劈下|劈向|直刺|刺来|刺向|刺入|扑上|扑来|扑向|翻滚|闪避|躲过|交手|厮杀|搏斗|打斗|开枪|射出|射向|撞开|撞飞|踢飞|踹开|踹向|一掌|拍向|摔倒|摔出|跃起|跃过|跃下|飞身|追击|追杀|追逐|逃命|逃跑|爆炸|爆开|格挡|反击|出招|拼杀|缠斗|近身|拳脚|甩出|飞镖|暗器|夺刀|夺剑|划开|刀光|剑锋|剑气|掌风|击中|击退|击落|扼住|掐住|勒住|锁喉|肘击|侧身躲|反手一掌|翻身跃|一脚踹|一脚踢|鲜血喷|血溅|扫腿/g,
  );
