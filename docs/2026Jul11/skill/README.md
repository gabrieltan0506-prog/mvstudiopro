...
| `screenwriter-genre-templates.md` | screenwriter-genre-templates | **Canvas only**（剧种 + 场景资产包） |
| `manhua-scene-asset-library.md` | manhua-scene-asset-library | **Canvas only**（20 爆款场景模板） |
