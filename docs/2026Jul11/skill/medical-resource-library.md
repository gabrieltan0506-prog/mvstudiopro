...
4. **包装强制对齐上表**：大数字选题包 / 硬核网站种草 / 八卦或漫画拟人 三选一作壳；**内容必须落到可打开资源**，不能只有口号。  
5. **封面协同**：医学向封面细节见 `cover-stop-scroll`「mk 密度课」；图文合集页见 `xhs-collectible-note`「mk 藏>赞」。  
6. **审核**：学者向观察；不给观众下诊断、不开处方、不承诺疗效。
